...
An application to build complete HTML pages in an output folder using a template and an input folder of incomplete HTML pages
...
### Install
  There are executables in the releases section. Download the .exe file if you are on Windows and the un-extended file
  ...
  https://go.dev/, clone this repository, and run "go build websiteBuilder.go" in your terminal to make a new file
